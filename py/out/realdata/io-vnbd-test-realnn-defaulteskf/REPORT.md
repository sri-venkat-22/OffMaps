...
**REPORTABLE**  ·  2026-09-23 11:07:30
...
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 26.4 | 27.8 | 100.0 | 27.8 | 0.4 | 2.81 |
| 30 | 60 | 45.6 | 118.3 | 350.3 | 97.8 | 14.4 | 4.11 |
| 60 | 58 | 49.5 | 212.6 | 655.3 | 168.5 | 80.9 | 4.53 |
| 120 | 42 | 49.9 | 456.5 | 1397.0 | 327.5 | 175.3 | 5.14 |
| 180 | 36 | 46.1 | 794.9 | 1919.9 | 495.1 | 287.7 | 5.44 |

overall **CEP50 172.4 m · CEP95 1176.1 m**

σ-calibration: z_var=8.28 z_mean=-0.84 (n=174256) → FAIL: z_var 8.28 outside [0.7,1.4]; |z_mean| 0.84 > 0.3 (biased speed)

### `eskf`  (n=256 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 33.5 | 30.6 | 108.4 | 30.3 | 3.3 | 2.60 |
| 30 | 60 | 40.0 | 98.7 | 363.8 | 78.6 | 33.1 | 3.59 |
| 60 | 58 | 41.6 | 204.9 | 636.5 | 145.7 | 82.2 | 3.58 |
| 120 | 42 | 46.2 | 454.7 | 1557.1 | 278.6 | 224.5 | 4.17 |
| 180 | 36 | 52.5 | 838.6 | 1804.1 | 516.8 | 336.8 | 4.30 |

overall **CEP50 149.8 m · CEP95 1212.0 m**

σ-calibration: z_var=0.78 z_mean=-0.68 (n=174256) → FAIL: |z_mean| 0.68 > 0.3 (biased speed)
