...
**REPORTABLE**  ·  2026-09-23 10:30:20
...
- manifest: `out/realdata/io-vnbd-test-synthnn/manifest.json`  (freshly frozen this run)
- seed: 0  ·  windows/duration requested: 30  ·  min-dist: 20.0 m
- reproduce: `python -m validate_realdata --layout iovnbd-sync --data ~/OffMaps-data/IO-VNBD-sync --include /Y1/|/S3a/ --n-per-duration 30 --out out/realdata/io-vnbd-test-synthnn`
...
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 87.6 | 83.4 | 174.0 | 77.8 | 4.9 | 8.50 |
| 30 | 60 | 82.6 | 200.8 | 468.1 | 180.4 | 41.3 | 7.22 |
| 60 | 58 | 70.1 | 352.4 | 902.2 | 268.1 | 155.5 | 7.12 |
| 120 | 42 | 59.7 | 543.5 | 1416.8 | 401.3 | 197.9 | 6.10 |
| 180 | 36 | 56.1 | 911.5 | 2337.8 | 545.5 | 345.4 | 6.98 |

overall **CEP50 253.1 m · CEP95 1304.6 m**

σ-calibration: z_var=30.94 z_mean=-5.64 (n=174256) → FAIL: z_var 30.94 outside [0.7,1.4]; |z_mean| 5.64 > 0.3 (biased speed)

### `eskf`  (n=256 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 87.6 | 83.4 | 174.0 | 77.9 | 6.2 | 8.48 |
| 30 | 60 | 78.5 | 192.5 | 459.8 | 175.0 | 39.0 | 7.21 |
| 60 | 58 | 74.8 | 367.3 | 921.8 | 266.4 | 181.6 | 7.07 |
| 120 | 42 | 66.2 | 639.2 | 1432.8 | 405.2 | 282.8 | 6.00 |
| 180 | 36 | 59.9 | 872.5 | 2338.4 | 595.3 | 420.8 | 6.89 |

overall **CEP50 268.0 m · CEP95 1347.4 m**

σ-calibration: z_var=20.99 z_mean=-5.63 (n=174256) → FAIL: z_var 20.99 outside [0.7,1.4]; |z_mean| 5.63 > 0.3 (biased speed)

### `nn`  (n=256 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 85.6 | 77.4 | 181.9 | 77.2 | 5.3 | 7.82 |
| 30 | 60 | 73.1 | 179.7 | 456.1 | 157.8 | 44.2 | 6.68 |
| 60 | 58 | 67.9 | 326.4 | 872.3 | 219.4 | 121.6 | 6.51 |
| 120 | 42 | 48.8 | 411.0 | 1404.8 | 301.2 | 220.7 | 5.43 |
| 180 | 36 | 43.3 | 700.1 | 2274.5 | 466.4 | 296.0 | 6.15 |

overall **CEP50 217.8 m · CEP95 1207.4 m**

σ-calibration: z_var=22.91 z_mean=-5.27 (n=174256) → FAIL: z_var 22.91 outside [0.7,1.4]; |z_mean| 5.27 > 0.3 (biased speed)
