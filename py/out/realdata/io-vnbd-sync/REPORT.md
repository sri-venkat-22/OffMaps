# Real-data validation — M (Driver B)/S-M#0, M (Driver B)/S-M#1, M (Driver B)/S-M#2, S (Driver A)/S1/S-S1#0, S (Driver A)/S2/S-S2#0, S (Driver A)/S2/S-S2#1, S (Driver A)/S3a/S-S3a#0, S (Driver A)/S3b/S-S3b#1, S (Driver A)/S3c/S-S3c#0, S (Driver A)/S4/S-S4#0, S (Driver A)/S4/S-S4#1, Y (Driver D)/Y1/S-Y1#3

**REPORTABLE**  ·  2026-09-23 09:46:21
...
- source: `/Volumes/Big Data/miscellaneous/IO-VNBD/Synchronised V abd S datasets/Categorised IOVNB Dataset`  (dataset dir)
- manifest: `out/realdata/io-vnbd-sync/manifest.json`  (freshly frozen this run)
- seed: 0  ·  windows/duration requested: 8  ·  min-dist: 20.0 m
- reproduce: `python -m validate_realdata --data /Volumes/Big Data/miscellaneous/IO-VNBD/Synchronised V abd S datasets/Categorised IOVNB Dataset --layout iovnbd-sync --out out/realdata/io-vnbd-sync`
...
|---|--:|--:|--:|---|
| M (Driver B)/S-M#0 | 44225 | 1.000 | 35554 | PASS |
| M (Driver B)/S-M#1 | 9242 | 0.998 | 7864 | PASS |
| M (Driver B)/S-M#2 | 52474 | 0.999 | 42999 | PASS |
| S (Driver A)/S1/S-S1#0 | 51744 | 0.999 | 36081 | PASS |
| S (Driver A)/S2/S-S2#0 | 1863 | 1.004 | 437 | PASS |
| S (Driver A)/S2/S-S2#1 | 91925 | 0.999 | 64606 | PASS |
| S (Driver A)/S3a/S-S3a#0 | 24554 | 0.998 | 20116 | PASS |
| S (Driver A)/S3b/S-S3b#1 | 4722 | 0.999 | 3000 | PASS |
| S (Driver A)/S3c/S-S3c#0 | 37178 | 0.999 | 29983 | PASS |
| S (Driver A)/S4/S-S4#0 | 35185 | 0.999 | 24948 | PASS |
| S (Driver A)/S4/S-S4#1 | 55780 | 0.998 | 41860 | PASS |
| Y (Driver D)/Y1/S-Y1#3 | 65542 | 0.999 | 48481 | PASS |
- ⚠ M (Driver B)/S-M#0: sync: tz +1h, skew +0.2s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.992
- ⚠ M (Driver B)/S-M#0: phone accel vs GNSS along-track accel corr 0.31 (weak: accel-driven models are handicapped on this drive)
- ⚠ M (Driver B)/S-M#1: sync: tz +1h, skew +0.3s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.998
- ⚠ M (Driver B)/S-M#2: sync: tz +1h, skew +0.2s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.995
- ⚠ S (Driver A)/S1/S-S1#0: sync: tz +1h, skew +0.3s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.994
- ⚠ S (Driver A)/S2/S-S2#0: sync: tz +1h, skew -0.3s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.834
- ⚠ S (Driver A)/S2/S-S2#1: sync: tz +1h, skew -0.3s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.991
- ⚠ S (Driver A)/S2/S-S2#1: phone accel vs GNSS along-track accel corr 0.36 (weak: accel-driven models are handicapped on this drive)
...
- ⚠ S (Driver A)/S3b/S-S3b#1: sync: tz +1h, skew +0.2s, yaw axis gyro 'Pitch' sign +1, yaw corr 1.000
- ⚠ S (Driver A)/S3b/S-S3b#1: phone accel vs GNSS along-track accel corr 0.33 (weak: accel-driven models are handicapped on this drive)
- ⚠ S (Driver A)/S3c/S-S3c#0: sync: tz +1h, skew +0.2s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.999
- ⚠ S (Driver A)/S3c/S-S3c#0: phone accel vs GNSS along-track accel corr 0.03 (weak: accel-driven models are handicapped on this drive)
- ⚠ S (Driver A)/S4/S-S4#0: sync: tz +1h, skew -0.1s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.992
- ⚠ S (Driver A)/S4/S-S4#0: phone accel vs GNSS along-track accel corr 0.44 (weak: accel-driven models are handicapped on this drive)
- ⚠ S (Driver A)/S4/S-S4#1: sync: tz +1h, skew -0.0s, yaw axis gyro 'Pitch' sign +1, yaw corr 0.967
- ⚠ S (Driver A)/S4/S-S4#1: phone accel vs GNSS along-track accel corr 0.22 (weak: accel-driven models are handicapped on this drive)
...
### `eskf_map`  (n=435 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 94 | 78.5 | 69.9 | 174.3 | 61.8 | 3.1 | 6.87 |
| 30 | 93 | 74.3 | 157.4 | 547.6 | 154.4 | 33.4 | 6.49 |
| 60 | 88 | 67.6 | 320.0 | 862.6 | 261.7 | 106.0 | 6.16 |
| 120 | 81 | 59.2 | 553.0 | 1665.2 | 367.3 | 213.3 | 6.21 |
| 180 | 79 | 56.2 | 749.8 | 2575.5 | 491.3 | 313.9 | 6.19 |

overall **CEP50 254.8 m · CEP95 1391.9 m**

σ-calibration: z_var=23.46 z_mean=-5.34 (n=329935) → FAIL: z_var 23.46 outside [0.7,1.4]; |z_mean| 5.34 > 0.3 (biased speed)

### `eskf`  (n=435 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 94 | 78.2 | 68.7 | 174.3 | 64.4 | 7.3 | 6.87 |
| 30 | 93 | 71.6 | 159.3 | 549.5 | 142.7 | 39.8 | 6.50 |
| 60 | 88 | 70.7 | 322.8 | 846.4 | 242.8 | 119.4 | 6.13 |
| 120 | 81 | 70.3 | 626.7 | 1480.5 | 413.6 | 270.3 | 6.19 |
| 180 | 79 | 66.6 | 892.5 | 2579.0 | 586.9 | 367.3 | 6.22 |

overall **CEP50 274.6 m · CEP95 1444.6 m**

σ-calibration: z_var=23.66 z_mean=-5.32 (n=329935) → FAIL: z_var 23.66 outside [0.7,1.4]; |z_mean| 5.32 > 0.3 (biased speed)

### `nn`  (n=435 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 94 | 65.4 | 52.4 | 171.5 | 51.5 | 6.1 | 6.00 |
| 30 | 93 | 61.2 | 136.4 | 540.6 | 116.7 | 31.5 | 5.83 |
| 60 | 88 | 48.8 | 236.9 | 804.2 | 182.5 | 83.9 | 4.95 |
| 120 | 81 | 44.7 | 381.6 | 1409.6 | 268.1 | 163.9 | 5.02 |
| 180 | 79 | 42.0 | 605.9 | 2370.3 | 340.3 | 306.0 | 4.93 |

overall **CEP50 189.6 m · CEP95 1278.1 m**

σ-calibration: z_var=25.12 z_mean=-4.46 (n=329935) → FAIL: z_var 25.12 outside [0.7,1.4]; |z_mean| 4.46 > 0.3 (biased speed)

### `physics`  (n=435 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 94 | 10.6 | 12.7 | 54.8 | 11.1 | 3.2 | 1.46 |
| 30 | 93 | 20.5 | 54.7 | 218.3 | 37.3 | 23.3 | 2.57 |
| 60 | 88 | 31.3 | 165.8 | 602.1 | 89.5 | 70.1 | 3.55 |
| 120 | 81 | 34.6 | 365.6 | 1109.4 | 225.7 | 184.3 | 4.41 |
| 180 | 79 | 37.8 | 614.9 | 1519.1 | 286.8 | 222.5 | 4.53 |

overall **CEP50 113.0 m · CEP95 1111.3 m**

### `cv`  (n=435 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 94 | 27.5 | 21.5 | 72.3 | 12.7 | 9.7 | 1.46 |
| 30 | 93 | 51.4 | 118.0 | 288.6 | 74.6 | 50.3 | 2.57 |
| 60 | 88 | 82.1 | 358.1 | 763.4 | 199.2 | 178.7 | 3.55 |
| 120 | 81 | 85.2 | 896.8 | 1799.5 | 572.7 | 467.8 | 4.41 |
| 180 | 79 | 79.5 | 1267.9 | 2540.7 | 720.2 | 684.5 | 4.53 |

overall **CEP50 257.3 m · CEP95 1739.7 m**
