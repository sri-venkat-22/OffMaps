...
**REPORTABLE**  ·  2026-09-23 11:01:47
...
- reproduce: `python -m validate_realdata --layout iovnbd-sync --data ~/OffMaps-data/IO-VNBD-sync --include /Y1/|/S3a/ --n-per-duration 30 --manifest out/realdata/io-vnbd-test-synthnn/manifest.json --nn-ckpt model/nn_real.pt --models eskf,nn --out out/realdata/io-vnbd-test-realnn`
...
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 46.8 | 46.3 | 101.1 | 42.3 | 4.1 | 4.09 |
| 30 | 60 | 61.1 | 155.5 | 425.0 | 129.8 | 43.3 | 5.15 |
| 60 | 58 | 69.3 | 325.0 | 1005.8 | 197.6 | 155.9 | 6.60 |
| 120 | 42 | 68.9 | 635.2 | 1859.6 | 434.3 | 299.8 | 6.46 |
| 180 | 36 | 67.7 | 1186.4 | 3100.1 | 517.7 | 580.9 | 6.64 |

overall **CEP50 236.7 m · CEP95 1889.9 m**

σ-calibration: z_var=0.28 z_mean=-0.25 (n=174256) → FAIL: z_var 0.28 outside [0.7,1.4]

### `nn`  (n=256 windows)

| dur (s) | n | drift % | CEP50 (m) | CEP95 (m) | along (m) | cross (m) | vMAE (m/s) |
|--:|--:|--:|--:|--:|--:|--:|--:|
| 10 | 60 | 56.6 | 50.1 | 116.9 | 47.3 | 5.3 | 8.05 |
| 30 | 60 | 47.5 | 133.6 | 332.4 | 101.3 | 20.5 | 7.93 |
| 60 | 58 | 40.4 | 205.6 | 562.2 | 128.6 | 106.5 | 7.61 |
| 120 | 42 | 44.1 | 402.6 | 898.4 | 276.1 | 137.3 | 7.84 |
| 180 | 36 | 36.1 | 676.4 | 1119.2 | 362.8 | 274.3 | 7.98 |

overall **CEP50 165.8 m · CEP95 816.7 m**

σ-calibration: z_var=0.91 z_mean=+0.01 (n=174256) → PASS
